...
%% NN vPA Settings.
p.pa_model.n_neurons = 50;
p.pa_model.n_hidden_layers = 1;
p.pa_model.memory_depth =  6; % If not 1, must be even.
p.pa_model.activation_function = 'logsig';
p.pa_model.loss_function = 'mse';
p.pa_model.optimizer = 'trainlm';
p.pa_model.rnn = 0;
p.pa_model.delay = 1:2;
p.pa_model.learning_rate = 0.01;
p.pa_model.n_epochs = 5000;
p.pa_model.linear_bypass = 0;
