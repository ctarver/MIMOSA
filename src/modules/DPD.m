classdef DPD < handle
    ...
    methods
        function obj = DPD(P, M , L, use_even, use_conj, use_dc_term, ...
                n_iterations, learning_rate, learning_method)
            ...
            obj.order = P;
            obj.use_even = use_even;
            obj.memory_depth = M;
            obj.lag_depth = L;
            obj.nIterations = n_iterations;
            obj.learning_rate = learning_rate;
            obj.learning_method = learning_method;
            obj.use_conj = use_conj;
            obj.use_dc_term = use_dc_term;
        ...
        function perform_learning(obj, x, pa)
            ...
            if length(obj) > 1
                for i = 1:length(obj)
                    obj(i).perform_learning(x(:,i), pa(i))
                end
                return;
            end
